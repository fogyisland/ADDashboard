...
test('GET /api/dashboard/site-replication-matrix: 200 returns site + dcs + links', async () => {
  const db = buildMockDb([
    ...
    // 2) DCs in site
    {
      ...
      rows: [
        { dc_name: 'DC-BJ-01', os_version: 'Win2022', is_pdc: 0, is_gc: 1, is_rid_master: 0, is_schema_master: 0, is_domain_naming_master: 0, is_infrastructure_master: 0, is_bridgehead: 0, discovered_at: new Date(), discovered_by_agent_id: 'DC-BJ-01' },
        { dc_name: 'DC-BJ-02', os_version: 'Win2019', is_pdc: 0, is_gc: 1, is_rid_master: 0, is_schema_master: 0, is_domain_naming_master: 0, is_infrastructure_master: 0, is_bridgehead: 0, discovered_at: new Date(), discovered_by_agent_id: 'DC-BJ-02' }
      ]
    },
    // 3) replication links
    {
