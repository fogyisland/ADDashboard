  ...
  <div class="modal-bg" @click.self="cancel">
    <div class="modal" data-test="user-password-reset-modal">
      ...
      <footer>
        ...
        <button type="button" data-test="user-password-reset-submit" class="primary" @click="submit" :disabled="submitting || !canSubmit || !props.targetDc" :title="!props.targetDc ? '请先选择目标 DC' : ''">提交</button>
      </footer>
    </div>
  </div>
</template>
